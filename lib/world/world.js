...
// other image. 
	...
	if		(placeX == "right"  )  var X = (c1x>c2x)? img2.getWidth()-(c1x+c2x) : img1.getWidth()-(c1x+c2x);
	else if (placeX == "left" )  var X = (c1x>c2x)? img1.getWidth()-(c1x+c2x) : img2.getWidth()-(c1x+c2x);
	else if (placeX == "beside")  var X = c1x+c2x;
	else if (placeX == "middle" || 
		 placeX == "center")  var X = 0;
	else						  var X = placeX;
	
	if		(placeY == "bottom"   )  var Y = (c1y>c2y)? img2.getHeight()-(c1y+c2y) : img1.getHeight()-(c1y+c2y);
	else if (placeY == "top")  var Y = (c1y>c2y)? img1.getHeight()-(c1y+c2y) : img2.getHeight()-(c1y+c2y);
