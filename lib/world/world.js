...
//	    "Unimplemented method render");
	...
	var that = this;
	var width = jsnums.toFixnum(world.Kernel.imageWidth(that));
	var height = jsnums.toFixnum(world.Kernel.imageHeight(that));
...
*/
    ...
    world.Kernel.overlayImage = function(img1, img2) {
	    return new OverlayImage(img1, img2);
    };
