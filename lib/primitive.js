...
var makeStructType = function(aState,
			      name,
			      superType,
			      initFieldCnt,
			      autoFieldCnt,
...
var getMakeStructTypeReturns = function(aStructType) {
	...
	return new types.ValuesWrapper(
		[aStructType,
		 (new PrimProc('make-'+name,
			       aStructType.numberOfArgs,
			       false,
			       false,
			       aStructType.constructor)),
		 (new PrimProc(name+'?', 1, false, false, aStructType.predicate)),
		 (new PrimProc(name+'-ref',
			       2,
			       false,
			       false,
			       function(x, i) {
