...
PRIMITIVES['string-set!'] =
    new PrimProc('string-set!',
		 ...
		 false, false,
		 function(str, k, c) {
		 	check(str, function(x) { return isString(x) && x.mutable; }, 'string-set!', 'mutable string', 1);
...
PRIMITIVES['string-fill!'] =
    new PrimProc('string-fill!',
		 ...
		 false, false,
		 function(str, c) {
		 	check(str, function(x) { return isString(x) && x.mutable; }, 'string-fill!', 'mutable string', 1);
