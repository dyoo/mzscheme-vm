...
PRIMITIVES['get-named-js-object'] =
    new PrimProc('get-named-js-object',
		 ...
		 function(name) {
			...
			return types.jsObject(nameStr, null, obj);
		 });
...
PRIMITIVES['get-js-object'] =
    new PrimProc('get-js-object',
		 ...
		 function(root, firstSelector, selectors) {
			...
			return types.jsObject(name.join('.'), parent, obj);
		 });
...
PRIMITIVES['get-js-array-field'] =
    new PrimProc('get-js-array-field',
		 ...
		 function(objArray, index) {
			...
			var i = jsnums.toFixnum(index);
			return types.jsObject(objArray.name+'['+i+']', null, objArray.obj[i]);
		 });
...
PRIMITIVES['js-call'] =
    new PrimProc('js-call',
		 ...
		 function(objF, initArgs) {
			...
			var jsCallReturn = objF.obj.apply(objF.parent, args);
