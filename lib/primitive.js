...
PRIMITIVES['js-p'] =
    makeOptionPrimitive('js-p',
			...
			function(userArgs, attribList) {
				...
				var wrappedNode = helpers.wrapJsObject(node);
				wrappedNode.toWrittenString = function(cache) { return "(js-p)"; };
				wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
				wrappedNode.toDomNode = function(cache) { return node; };
				return wrappedNode;
			});
...
PRIMITIVES['js-div'] =
    makeOptionPrimitive('js-div',
			...
			function(userArgs, attribList) {
				...
				var wrappedNode = helpers.wrapJsObject(node);
				wrappedNode.toWrittenString = function(cache) { return "(js-div)"; };
				wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
				wrappedNode.toDomNode = function(cache) { return node; };
				return wrappedNode;
			});
...
var jsButtonBang = function(funName) {
	return function(updateWorldF, effectF, attribList) {
		var attribs = attribList ? assocListToHash(attribList) : {};
		var node = jsworld.MobyJsworld.buttonBang(updateWorldF, effectF, attribs);

		var wrappedNode = helpers.wrapJsObject(node);
		wrappedNode.toWrittenString = function(cache) { return '(' + funName + ' ...)'; };
		wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
		wrappedNode.toDomNode = function(cache) { return node; };
		return wrappedNode;
	}
...
PRIMITIVES['js-button!'] =
    makeOptionPrimitive('js-button!',
			...
			function(userArgs, updateWorldF, effectF, attribList) {
				check(updateWorldF, isFunction, 'js-button!', 'procedure', 1, userArgs);
				check(effectF, isFunction, 'js-button!', 'procedure', 2, userArgs);
				checkListOf(attribList, isAssocList, 'js-button!', '(listof X Y)', 3, userArgs);
...
PRIMITIVES['js-input'] =
    makeOptionPrimitive('js-input',
			...
			function(userArgs, type, updateF, attribList) {
				...
				var wrappedNode = helpers.wrapJsObject(node);
				wrappedNode.toWrittenString = function(cache) { return "(js-input ...)"; }
				wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
				wrappedNode.toDomNode = function(cache) { return node; }
				return wrappedNode;
			});
...
PRIMITIVES['js-img'] =
    makeOptionPrimitive('js-img',
			...
			function(userArgs, src, attribList) {
				...
				var wrappedNode = helpers.wrapJsObject(node);
				wrappedNode.toWrittenString = function(cache) { return "(js-img ...)"; }
				wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
				wrappedNode.toDomNode = function(cache) { return node; }
				return wrappedNode;
			});
...
PRIMITIVES['js-text'] =
    new PrimProc('js-text',
		 ...
		 function(s) {
			...
			var wrappedNode = helpers.wrapJsObject(node);
			wrappedNode.toWrittenString = function(cache) { return "(js-text ...)"; }
			wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
			wrappedNode.toDomNode = function(cache) { return node; }
			return wrappedNode;
		 });
...
PRIMITIVES['js-select'] =
    makeOptionPrimitive('js-select',
			...
			function(userArgs, optionList, updateF, attribList) {
				...
				var wrappedNode = helpers.wrapJsObject(node);
				wrappedNode.toWrittenString = function(cache) { return '(js-select ...)'; };
				wrappedNode.toDisplayedString = wrappedNode.toWrittenString;
				wrappedNode.toDomNode = function(cache) { return node; };
				return wrappedNode;
			});
