...
PRIMITIVES['wrap-world-handler'] =
    new PrimProc('wrap-world-handler',
		 1,
		 false, false,
		 function(handler) {
		 	check(handler, isFunction, 'wrap-world-handler', 'procedure', 1);
			return types.wrappedWorldHandler(handler);
		 });
