	...
	new CasePrimitive(
	    ...
	    [new PrimProc('on-tick',
	     ...
	     new PrimProc('on-tick',
			  ...
			  function(f, aDelay) {
			      check(f, isFunction, "on-tick", "procedure", 1);
			      check(aDelay, isNumber, "on-tick", "number", 2);
			      return new OnTickBang(f,
						    new PrimProc('', 1, false, false,
								 function(w) { return types.effectDoNothing(); }),
						    aDelay);
...
PRIMITIVES['on-tick!'] =
	...
	[new PrimProc('on-tick!',
			  ...
			  check(handler, isFunction, "on-tick!", "procedure", 1);
			  check(effectHandler, isFunction, "on-tick!","procedure", 2);
	 ...
	 new PrimProc('on-tick!',
			  ...
			  check(handler, isFunction, "on-tick!", "procedure", 1);
			  check(effectHandler, isFunction, "on-tick!","procedure", 2);
			  check(aDelay, isNumber, "on-tick!", "number", 3);
