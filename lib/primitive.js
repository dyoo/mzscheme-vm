...
PRIMITIVES['get-js-object'] =
    new PrimProc('get-js-object',
		 2,
		 true, false,
		 function(parent, firstSelector, selectors) {
		 	selectors.unshift(firstSelector);
		 	check(parent, types.isJsObject, 'get-js-object', 'js-object', 1);
...
PRIMITIVES['js-call'] =
    new PrimProc('js-call',
		 ...
		 function(objF, initArgs) {
			...
			var jsCallReturn = objF.obj.apply(null, args);
