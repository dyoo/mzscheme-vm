...
//				  types.arityAtLeastValue( arity.first() ) <= n ) {
//				return true;
//			}
//			arity = arity.rest();
//		}
...
PRIMITIVES['js-img'] =
    makeOptionPrimitive('js-img',
			...
			function(userArgs, src, attribList) {
				...
				var attribs = assocListToHash(attribList);
				var node = helpers.wrapJsValue( jsworld.Jsworld.img(src, attribs) );
...
PRIMITIVES['js-text'] =
    new PrimProc('js-text',
		 ...
		 function(s) {
			...
			var node = helpers.wrapJsValue( jsworld.Jsworld.text(s, []) );
...
PRIMITIVES['js-get-global-value'] =
...
PRIMITIVES['js-undefined'] = types.jsValue('undefined', undefined);
PRIMITIVES['js-null'] = types.jsValue('null', null);
