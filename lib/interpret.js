...
State.prototype.step = function() {
	...
	case 'seq':
	    ...
	    break;
	case 'application':
	    this.pushValue(this.evaluateApplication(nextCode));
	    break;
	default:
...
State.prototype.evaluateApplication = function(anApp) {
    var rator = anApp.rator;
    var rands = anApp.rands;
    this.pushControl(CallFunction(rands.length));
