...
var processPrimitiveResult = function(state, result, procValue) {
    sys.print("primitive result: " + sys.inspect(result) + "\n");
    if (result instanceof INTERNAL_CALL) {
	sys.print("internal call\n");
	state.cstack.push(new InternalCallRestartControl(result.k, procValue));
	callProcedure(result.operator, result.operands.length, result.operands);
    } else {
...
InternalCallRestartControl.prototype.invoke = function(state) {
    if (! (state.v instanceof ValuesWrapper)) {
	processPrimitiveResult(state,
			       this.k(state.v), 
			       this.procValue);
    } else {
	processPrimitiveResult(state, 
			       this.k.apply(null, state.v.elts),
			       this.procValue);
    }
};
...
var callContinuationProcedure = function(state, procValue, n, operandValues) {
	...
	state.v = new ValuesWrapper(operandValues);
    }
...
//////////////////////////////////////////////////////////////////////
exports.ConstantControl = ConstantControl;
exports.BranchControl = BranchControl;
exports.SeqControl = SeqControl;
exports.Beg0Control = Beg0Control;
exports.ModControl = ModControl;
exports.Prefix = Prefix;
exports.ToplevelControl = ToplevelControl;
exports.DefValuesControl = DefValuesControl;
exports.LamControl = LamControl;
exports.PrimvalControl = PrimvalControl;
exports.ApplicationControl = ApplicationControl;
exports.LocalrefControl = LocalrefControl;
exports.ApplyValuesControl = ApplyValuesControl;
exports.LetOneControl = LetOneControl;
exports.LetVoidControl = LetVoidControl;
exports.BoxenvControl = BoxenvControl;
exports.InstallValueControl = InstallValueControl;
exports.WithContMarkControl = WithContMarkControl;
exports.AssignControl = AssignControl;
exports.VarrefControl = VarrefControl;
exports.ClosureControl = ClosureControl;
exports.CaseLamControl = CaseLamControl;
exports.LetRecControl = LetRecControl;
