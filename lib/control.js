...
// PromptControl: integer types.PromptTag (PrimProc | false)
...
var abortToPrompt = function(aState, prompt) {
    // FIXME: implement!
    // First, find the appropriate prompt.
    // Chop the context down
    // Call the prompt's handler.
};
...
control.abortToPrompt = abortToPrompt;
