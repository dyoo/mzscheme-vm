...
var invokeModuleAndRestart = function(aState, 
	...
	invokeJavascriptModuleAndRestart(aState, resolvedModuleName, moduleRecord, onSuccess, onFail);
    } else {
	invokeSchemeModuleAndRestart(aState, resolvedModuleName, moduleRecord, onSuccess, onFail);
    }
};
...
var invokeJavascriptModuleAndRestart = function(aState, resolvedModuleName, moduleRecord, onSuccess, onFail) {
    var EXPORTS = {};
    try {
