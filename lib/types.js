...
Str.prototype.toWrittenString = function(cache) {
    return escapeString(this.chars);
}
...
var ExnFail = makeStructureType('exn:fail', ['message', 'continuation-marks']);
...
var Posn = makeStructureType('posn', ['x', 'y']);
var Color = makeStructureType('color', ['red', 'green', 'blue']);
var ArityAtLeast = makeStructureType('arity-at-least', 'value');
...
types.isSchemeError = function(v) { return x instanceof SchemeError; };
