...
exports.symbol = Symbol.makeInstance;
exports.rational = jsnums.makeRational;
exports.float = jsnums.makeFloat;
exports.complex = jsnums.makeComplex;
exports.list = makeList;
exports.vector = makeVector;
exports.regexp = function(p) { return new RegularExpression(p) ; }
exports.byteRegexp = function(p) { return new ByteRegularExpression(p) ; }
exports['char'] = Char.makeInstance;
exports.box = function(x) { return new Box(x); };
exports.path = function(x) { return new Path(x); };
exports.bytes = function(x) { return new Bytes(x); };
exports.keyword = function(k) { return new Keyword(k); };
exports.pair = function(x, y) { return Cons.makeInstance(x, y); };
...
exports.cons = Cons.makeInstance;

exports.UNDEFINED = UNDEFINED_VALUE;
exports.VOID = VOID_VALUE;

exports.ValuesWrapper = ValuesWrapper;
exports.ClosureValue = ClosureValue;
exports.ContinuationClosureValue = ContinuationClosureValue;
exports.CaseLambdaValue = CaseLambdaValue;

exports.PrefixValue = PrefixValue;
exports.VariableReference = VariableReference;



exports.Box = Box;
exports.ThreadCell = ThreadCell;


exports.NumberTower = NumberTower;
