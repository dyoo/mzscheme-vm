...
//		var guardedArgs;
//		if (guard) {
//			var guardRes = guard.apply(null, initArgs.concat([name]));
...
//		theArgs = [cont].concat(initArgs.concat([name]));
...
var ArityAtLeast = makeStructureType('arity-at-least', false, 1, 0, false, false);
...
var Effect = makeStructureType('effect', false, 1, 0, false,
		function(k, thunk, name) {
