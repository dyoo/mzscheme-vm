...
var WrappedWorldHandler = function(handler) {
	this.handler = handler;
};

WrappedWorldHandler.prototype.toString = function() {
	return '#<wrapped-world-handler>';
};

WrappedWorldHandler.prototype.isEqual = function(other, aUnionFind) {
...
types.wrappedWorldHandler = function(handler) { return new WrappedWorldHandler(handler); };
types.isWrappedWorldHandler = function(x) { return x instanceof WrappedWorldHandler; };
