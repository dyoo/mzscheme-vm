...
toWrittenString = function(x, cache) {
    if (! cache) { 
...
toDisplayedString = function(x, cache) {
    if (! cache) {
	cache = makeLowLevelEqHash();
    }
    if (x && cache.containsKey(x)) {
...
isEqual = function(x, y, aUnionFind) {
    if (x === y) { return true; }
...
liftToplevelToFunctionValue = function(primitiveF,
				       name,
				       minArity, 
...
exports.rational = Rational.makeInstance;
