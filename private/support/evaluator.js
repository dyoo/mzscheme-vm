...
var Evaluator = (function() {
	...
	var line, column, id;
	while(child) {
	    if (child['className'] === 'location-id') {
		id = child.textContent;
	    }
	    if (child['className'] === 'location-offset') {
		// ignore for now
	    }
	    if (child['className'] === 'location-line') {
		line = child.textContent;
	    }
	    if (child['className'] === 'location-column') {
		column = child.textContent;
	    }
	    if (child['className'] === 'location-span') {
		// ignore for now
	    }
